  ...
  return (
    <div
      className={`${className} mx-auto my-4 gap-4 
        ${type === "grid2" ? "grid grid-cols-1 md:grid-cols-2" : ""}
        ${type === "grid3" ? "grid grid-cols-1 md:grid-cols-3" : ""}
        ${type === "grid4" ? "grid grid-cols-1 md:grid-cols-4" : ""}
        ${type === "grid5" ? "grid grid-cols-1 md:grid-cols-5" : ""}
